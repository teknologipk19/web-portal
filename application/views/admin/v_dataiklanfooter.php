            ...
            <div class="box">
              ...
              <div class="box-body">
                <table id="example1" class="table table-bordered">
                  ...
                  <tbody>
                    <?php $no=1; foreach ($listdataiklanfooter as $data) { ?>
                      <tr>
                        ...
                        <td>
                          <a href="<?php echo base_url('admin/superadmin/editdataiklanfooter/'.$data['id_iklan']);?>"><i class="glyphicon glyphicon-pencil"></i></a></a>
                      ...
                      <div class="modal fade" id="modal-default<?php echo $data['id_iklan'];?>">
                        <div class="modal-dialog">
                          <form method="post" action="<?php echo base_url('admin/superadmin/hapusdataiklanfooter');?>">
