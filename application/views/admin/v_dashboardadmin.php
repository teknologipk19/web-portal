      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <?php foreach ($hitungberita as $ba) { ?>
                <h3><?php echo $ba['judul_berita'];?></h3>
              <?php } ?>  
              <p>Data Berita</p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <?php foreach ($hitungiklan as $ba) { ?>
                <h3><?php echo $ba['img_iklan'];?></h3>
              <?php } ?>  
              <p>Data Iklan</p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <?php foreach ($hitungkategori as $ba) { ?>
                <h3><?php echo $ba['kategori_berita'];?></h3>
              <?php } ?>  
              <p>Kategori Berita</p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <?php foreach ($hitungadmin as $ba) { ?>
                <h3><?php echo $ba['username'];?></h3>
              <?php } ?>  
              <p>Data Admin</p>
            </div>
            <div class="icon">
