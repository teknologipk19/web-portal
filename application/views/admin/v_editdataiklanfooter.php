  ...
  <div class="wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        <div class="box-body">
          <div class="row">
            <form method="post" action="<?php echo base_url('admin/superadmin/editdataiklanfooter');?>" enctype="multipart/form-data"> 
              <!-- /.col -->
              <div class="col-md-12">
                <?php
              ...
              <div class="col-md-12">
                <div class="form-group">
                  <img src="<?php echo base_url('assets/admin/upload/iklan/'.$img_iklan);?>" alt="gambar" width="100" height="100">
                </div>  
              </div>  
              <div class="col-md-12">
                <!-- /.form-group -->
                <div class="form-group">
                  ...
                  <input type="file" name="img_iklan" id="img_iklan" class="form-control" value="<?php echo (isset($img_iklan)) ? $img_iklan : "img_iklan";?>">
                </div>
              </div>
              <div class="col-md-12">
                <div class="form-group">
