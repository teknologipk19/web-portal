  ...
  <div class="wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        <div class="box-body">
          <div class="row">
            <form method="post" action="<?php echo base_url('admin/superadmin/tambahmasterdataberita');?>" enctype="multipart/form-data"> 
              <div class="col-md-12">
                <?php
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="status_publish" style="width: 100%;">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="kategori_berita" style="width: 100%;">
                    <?php foreach ($listmasterdatakategori as $ba) { ?>
                      <option value="<?php echo $ba['kategori_berita'];?>"><?php echo $ba['kategori_berita'];?></option>
                    <?php } ?>  
                  </select>
                </div>
                <!-- /.form-group -->
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea id="editor1" name="isi_berita" rows="10" cols="80"></textarea>
                </div>  
              </div>  
              <div class="col-md-12">
                <div class="form-group">
