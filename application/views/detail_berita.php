      ...
      <div class="col-lg-8 col-md-8">
        <div class="content_bottom_left">
          <div class="single_page_area">
            ...
            <?php foreach ($listdetailberita as $ba) { ?>
              <h2 class="post_titile"><?php echo $ba['judul_berita'];?> </h2>
              <div class="single_page_content">
                <div class="post_commentbox"> <a href="#"><i class="fa fa-user"></i><?php echo $ba['author']?></a> <span><i class="fa fa-calendar"></i><?php echo date('d-M-Y', strtotime($ba['tanggal'])) ?></span> <a href="#"><i class="fa fa-tags"></i><?php echo $ba['kategori_berita']?></a> </div>
                <img class="img-center" src="<?php echo base_url('./assets/admin/upload/berita/'.$ba['gambar']);?>" alt="">
                <p><?php echo $ba['isi_berita']?></p>
        ...
        <div class="similar_post">
          ...
          <ul class="small_catg similar_nav wow fadeInDown animated">
            <li>
              <div class="media wow fadeInDown animated" style="visibility: visible; animation-name: fadeInDown;"> <a class="media-left related-img" href="#"><img src="<?php echo base_url();?>assets/dashboard/images/112x112.jpg" alt=""></a>
      ...
      <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
          <div class="footer_bottom_left">
            <p>Copyright &copy; 2045 <a href="<?php echo base_url();?>assets/dashboard/index.html">magExpress</a></p>
          </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
